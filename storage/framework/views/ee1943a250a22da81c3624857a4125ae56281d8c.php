  ...
  <section id="book" class="py-32 px-4 md:px-32 bg-no-repeat bg-center bg-cover w-full relative z-1 text-center" style="background-image: url(<?php echo e($tableBg); ?>)">
    ...
    <form action="<?php echo e(url('/makereservation')); ?>"  method="post" enctype="multipart/form-data" class="bg-slate-800/75 border-2 inline-block px-6 py-8 shadow-md">
      <?php echo csrf_field(); ?>
      ...
      <div class="flex flex-wrap items-center justify-center">
        ...
        <div class="m-3 relative">
          ...
          <input type="text" id="timepicker" name="time" class="w-48 md:w-24 rounded pl-8 text-[14px] font-sans-lato text-slate-700 leading-relaxed" placeholder="Time">
        </div>
        <div class="m-3 relative">
