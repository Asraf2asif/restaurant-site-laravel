<!-- Food Area starts -->
    <section class="bg-no-repeat bg-[right_top_15rem] md:bg-right-top py-28 md:pt-32 w-full" style="background-image: url(<?php echo e($foodBg); ?>)">
      <div class="flex flex-col items-center food-sm:items-start max-w-[980px] mx-auto">
        ...
        <div class="max-w-[290px] m-4">
          <img src=<?php echo e($data['img']); ?> class="w-full h-auto" alt=<?php echo e($data['name']); ?> />
          <div class="group p-7 bg-slate-100 hover:bg-amber-400 transition duration-300 min-h-[170px]">
