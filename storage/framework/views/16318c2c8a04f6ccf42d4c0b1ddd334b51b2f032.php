...
<?php $component->withAttributes([]); ?>
	<div class="content-wrapper">
		<a href="<?php echo e(url('/admin/foodmenu/addform')); ?>" class="btn btn-primary mx-2">Add New Food</a>
	</div>
					...
					<table class="table table-hover overflow-auto block">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a
										href="<?php echo e(url('/admin/foodmenu/editform', $data->id)); ?>"
								...
								<td>
									...
									<a
										...
										href="<?php echo e(url('/admin/foodmenu/del', $data->id)); ?>"
										class="badge badge-danger cursor-pointer"
										>Delete</a
									>
									<?php else: ?>
									<button
										onclick="alert('Only admin can delete food item')"
										class="badge badge-danger cursor-pointer"
										>Delete</button>
									<?php endif; ?>
								</td>
